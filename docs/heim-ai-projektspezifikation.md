...
### "interner Fehler bei der Antwortgenerierung" nur im Audio-Zweig (NEU in v1.11.3)
...
**Status:** Ursache wird mit dem nächsten App-Test aus der jetzt sichtbaren Fehlermeldung bestimmt. Häufigster Verdacht bei lokalen Modellen: das Modell/LM-Studio antwortet im Sprach-Turn mit einem Fehler (Chat-Template ohne Tool-Support, Kontext-Overflow durch längere Sprach-Antworten, oder die zweite LLM-Runde der Sprach-Kurzfassung). Text-Turns treffen das nicht, weil sie kürzer sind und keine Kurzfassung auslösen.
