...
- [~] **TTS-Evaluation** – Werkzeug steht (v1.17): Engine-Wechsel + Probehören mit Latenzmessung im Panel. Erste Test-Engine **Breeze TTS 2** eingebaut, als offizieller PyTorch-Server oder als Breeze-TTS-2.cpp (Q8_0, v1.18) (offiziell nur EN/ZH → deutscher Praxistest auf der VM offen, ebenso Tempo auf der RTX 2080 Ti). Nächster Kandidat mit offizieller Deutsch-Unterstützung: **Qwen3-TTS** (Apache-2.0, 0.6B/1.7B, 10 Sprachen inkl. Deutsch, Voice-Cloning mit Referenz + Transkript, Streaming — [GitHub](https://github.com/QwenLM/Qwen3-TTS)); weiterhin offen: Kokoro, StyleTTS2, Orpheus TTS
